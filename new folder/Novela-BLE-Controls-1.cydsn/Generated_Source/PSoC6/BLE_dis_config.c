...
{
    0x0011u,    /* Handle of the DIS service */
    {
        0x0013u, /* Handle of the Manufacturer Name String characteristic */ 
        0x0015u, /* Handle of the Model Number String characteristic */ 
        0x001Bu, /* Handle of the Serial Number String characteristic */ 
        0x0017u, /* Handle of the Hardware Revision String characteristic */ 
        0x0019u, /* Handle of the Firmware Revision String characteristic */ 
        0x001Du, /* Handle of the Software Revision String characteristic */ 
        0x001Fu, /* Handle of the System ID characteristic */ 
