...
#define CY_BLE_SCN_PKT_0_INDEX_TX_POWER_LEVEL   (0x0Du)
#define CY_BLE_SCN_PKT_0_INDEX_APPEARANCE   (0x10u)
...
#define CY_BLE_CONFIG_GATT_DB_MAX_VALUE_LEN         (0x001Du)
 ...
 */
#define CY_BLE_LED_SERVICE_INDEX   (0x00u) /* Index of LED service in the cy_ble_customs array */
#define CY_BLE_LED_GREEN_CHAR_INDEX   (0x00u) /* Index of GREEN characteristic */
#define CY_BLE_LED_GREEN_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_LED_PA_CHAR_INDEX   (0x01u) /* Index of PA characteristic */
#define CY_BLE_LED_PA_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_LED_MUX_CHAR_INDEX   (0x02u) /* Index of MUX characteristic */
#define CY_BLE_LED_MUX_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_LED_OSC_CHAR_INDEX   (0x03u) /* Index of OSC characteristic */
#define CY_BLE_LED_OSC_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_LED_MISC_CHAR_INDEX   (0x04u) /* Index of MISC characteristic */
#define CY_BLE_LED_MISC_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CY_BLE_LED_SERVICE_HANDLE   (0x000Eu) /* Handle of LED service */
#define CY_BLE_LED_GREEN_DECL_HANDLE   (0x000Fu) /* Handle of GREEN characteristic declaration */
#define CY_BLE_LED_GREEN_CHAR_HANDLE   (0x0010u) /* Handle of GREEN characteristic */
#define CY_BLE_LED_GREEN_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0011u) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LED_PA_DECL_HANDLE   (0x0012u) /* Handle of PA characteristic declaration */
#define CY_BLE_LED_PA_CHAR_HANDLE   (0x0013u) /* Handle of PA characteristic */
#define CY_BLE_LED_PA_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0014u) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LED_MUX_DECL_HANDLE   (0x0015u) /* Handle of MUX characteristic declaration */
#define CY_BLE_LED_MUX_CHAR_HANDLE   (0x0016u) /* Handle of MUX characteristic */
#define CY_BLE_LED_MUX_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0017u) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LED_OSC_DECL_HANDLE   (0x0018u) /* Handle of OSC characteristic declaration */
#define CY_BLE_LED_OSC_CHAR_HANDLE   (0x0019u) /* Handle of OSC characteristic */
#define CY_BLE_LED_OSC_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x001Au) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LED_MISC_DECL_HANDLE   (0x001Bu) /* Handle of MISC characteristic declaration */
#define CY_BLE_LED_MISC_CHAR_HANDLE   (0x001Cu) /* Handle of MISC characteristic */
#define CY_BLE_LED_MISC_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x001Du) /* Handle of Characteristic User Description descriptor */
